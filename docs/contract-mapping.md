...
| :------------------- | :-------------------------- |
| `vault`, `deposit`   | `SpectralDepositEvent`      |
| `vault`, `withdraw`  | `SpectralWithdrawalEvent`   |
| `vault`, `rebalance` | `SpectralRebalanceEvent`    |
| `vault`, `config`    | `SpectralConfigUpdateEvent` |
| `vault`, `fees`      | `SpectralFeeClaimEvent`     |
